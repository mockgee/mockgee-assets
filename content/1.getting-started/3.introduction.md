---
title: Introduction
description: 'Mockgee is an enterprise-grade API mocking server built from the ground up with enterprise use cases. It has an intuitive user interface for working with API mocks. It is highly performant and supports the technical capability for real API.'
---
...
- Dynamic response field's value
- Set Default Mock response / Proxy request
- Mock API tracing
- Bulk mock creation using CSV import
- Poweful UI
- Handles JSON, XML, SOAP and Text
- Blazing fast
- Support standard HTTP methods and Status Code
::
...
<video poster="https://s3.eu-west-1.amazonaws.com/app.mockgee.com/public/images/mock-add-1.png" loop playsinline controls>
  <!-- <source src="https://res.cloudinary.com/nuxt/video/upload/q_auto/v1588091670/nuxt-content_wxnjje.webm" type="video/webm" /> -->
  <source src="https://s3.eu-west-1.amazonaws.com/app.mockgee.com/public/videos/mock-add-1.mp4" type="video/mp4" />
...
<video poster="https://s3.eu-west-1.amazonaws.com/app.mockgee.com/public/images/mock-default.png" loop playsinline controls>
  <!-- <source src="https://res.cloudinary.com/nuxt/video/upload/q_auto/v1588095794/nuxt-content-movies_c0cq9p.webm" type="video/webm" /> -->
  <source src="https://s3.eu-west-1.amazonaws.com/app.mockgee.com/public/videos/mock-default-1.mp4" type="video/mp4" />
